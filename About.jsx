        ...
        <div class="row align-items-center my-6">
          ...
          <br/>
            <img
              ...
              src="https://thumbs.dreamstime.com/b/team-group-doctors-nurses-medicine-healthcare-concept-43916218.jpg"
              alt=""
            />
          </div>
          <div class="col-lg-15">
            <br/>
            <h3 style={{ fontWeight: 'bold' }}>Health Care Medical Care</h3>
            <p style={{ fontSize: 20}}>
